...
exec('./MyCompress ./testFiles/testFile.txt ./testFiles/myCompressOutput.txt', (err, stdout, stderr) => {
...
exec('./MyCompress ./blah.txt ./output.txt', (err, stdout, stderr) => {
...
exec('./MyDecompress ./testFiles/testCompressedOutput.txt ./testFiles/myDecompressOutput.txt', (err, stdout, stderr) => {  
...
// run my compress on error condition
exec('./MyDecompress ./blah.txt ./output.txt', (err, stdout, stderr) => {
...
exec('./ForkCompress ./testFiles/testFile.txt ./testFiles/forkCompressOutput.txt', (err, stdout, stderr) => { 
...
exec('./ForkCompress ./blah.txt ./output.txt', (err, stdout, stderr) => { 
...
exec('./PipeCompress ./testFiles/testFile.txt ./testFiles/PipeCompressOutput.txt', (err, stdout, stderr) => {
...
exec('./PipeCompress ./blah.txt ./output.txt', (err, stdout, stderr) => { 
...
exec('./ParFork ./testFiles/testFile.txt ./testFiles/ParForkOutput.txt', (err, stdout, stderr) => {
...
exec('./ParFork ./blah.txt ./output.txt', (err, stdout, stderr) => {
...
// run ParThread
exec('./ParThread ./testFiles/testFile.txt ./testFiles/ParThreadOutput.txt', (err, stdout, stderr) => {
...
exec('./ParThread ./blah.txt ./output.txt', (err, stdout, stderr) => {
